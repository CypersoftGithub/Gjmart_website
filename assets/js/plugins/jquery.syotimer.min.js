 ...
 * http://syomochkin.xyz/folio/syotimer/demo
 */
!(function (i, e) {
      ...
      _render: function () {
        for (
          var e = l(this),
            ...
            i = y.getTimerItem(),
            n = l("<div/>", { class: "syotimer__head" })(t.headTitle),
            o = l("<div/>", { class: "syotimer__body" }),
            r = l("<div/>", { class: "syotimer__footer" })(t.footTitle),
            a = {},
            s = 0;
      ...
      _refreshUnitsDom: function (e) {
        ...
        for (var a = 0; a < o.length; a++) {
          ...
          u.data("syotimer-unit-value", d),
            l(".syotimer-cell__value", u)(
              y.format2(d, s !== m && i.doubleNumbers)
            ),
            l(".syotimer-cell__unit", u)(
